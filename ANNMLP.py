...
import pandas as pd
train = pd.read_csv("C:/Users/Bharani Kumar/Downloads/train_sample (1).csv/train_sample (1).csv")
test = pd.read_csv("C:/Users/Bharani Kumar/Downloads/test_sample (1).csv/test_sample (1).csv")
